...
class UITabBarCustom: UITabBarController, UITabBarControllerDelegate {
    ...
    func generateTabButton(_ intTag: Int, isSelected boolSel: Bool) -> UIButton {
        ...
        case 0: //Tab-1
            ...
            btn.setImage(#imageLiteral(resourceName: "home_icon"), for: .selected)
        case 1: //Tab-2
           
            //btn.setTitle("", for: .normal) // List
            btn.setImage(#imageLiteral(resourceName: "my_acc"), for: .normal)
            btn.setImage(#imageLiteral(resourceName: "myacc_fill"), for: .selected)
        ...
        case 2: //Tab-3
            ...
            btn.setImage(#imageLiteral(resourceName: "notification_filll"), for: .selected)
        ...
        case 3: //Tab-4
            ...
            btn.setImage(#imageLiteral(resourceName: "setting_fill"), for: .selected)
